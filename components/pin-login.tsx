            ...
            <div className="mt-6 pt-4 border-t border-pink-200">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="flex-1 h-12 bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-900 hover:to-black text-white border-0 shadow-md"
                >
                ...
                <Button
                  ...
                  className="flex-1 h-12 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white border-0 shadow-md disabled:opacity-50"
                >
                  <div className="flex items-center gap-2">
